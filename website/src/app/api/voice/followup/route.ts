...
export async function POST(req: NextRequest) {
    try {
        ...
        const endpoint = `${backendUrl}/voice/followup`;
        ...
        if (!response.ok) {
            ...
            console.error("Voice pipeline followup error:", errorText);
        ...
        console.error("Error connecting to voice pipeline followup:", error);
        return NextResponse.json(
